...
namespace TheOtherRoles.Patches
{
    public static class UsablesPatch
    {
        ...
        public static bool IsAdminBlocked()
        {
            return MapOptions.disableAdmin;
        }
        ...
        public static bool IsBlocked(SystemConsole console, PlayerControl pc)
        {
            ...
            if ((isSecurity && MapOptions.disableCameras) || (isVitals && MapOptions.disableVitals)) return true;
            return false;
        }
        public static bool IsBlocked(IUsable target, PlayerControl pc)
        {
            ...
            if ((targetConsole != null && IsBlocked(targetConsole, pc)) ||
                ...
                (targetMapConsole != null && IsAdminBlocked()))
            {
                return true;
            }
            return false;
